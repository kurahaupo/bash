...
#  define Q_ARITH		 0x100
				/* expanding string for arithmetic evaluation */
...
#  define ASS_ALLOWALLSUB	0x0800
				/* allow * and @ as associative array keys */
...
#  define SD_NOQUOTEDELIM	0x004
				/* don't let single or double quotes act as delimiters */
...
#  define SD_IGNOREQUOTE	0x020
				/* single and double quotes are not special */
#  define SD_GLOB		0x040
				/* skip over glob patterns like bracket expressions */
