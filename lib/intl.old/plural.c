...
static inline struct expression *new_exp_1 (enum operator  op, struct expression *right);
...
static inline struct expression *new_exp_3 (enum operator  op,
					    struct expression *bexp, struct expression *tbranch, struct expression *fbranch);
...
yysetstate:
  *yyssp = yystate;
  ...
  if (yyss + yystacksize - 1 <= yyssp)
	...
	yyoverflow ("parser stack overflow", &yyss1, yysize * sizeof (*yyssp), &yyvs1, yysize * sizeof (*yyvsp), &yystacksize);
