...
#  ifdef _INTL_REDIRECT_INLINE
  extern char *libintl_gettext (const char *__msgid) _INTL_MAY_RETURN_STRING_ARG (1);
...
#    endif
  extern char *gettext (const char *__msgid) _INTL_ASM (libintl_gettext) _INTL_MAY_RETURN_STRING_ARG (1);
#  endif

/* Look up MSGID in the DOMAINNAME message catalog for the current
   LC_MESSAGES locale.  */
#  ifdef _INTL_REDIRECT_INLINE
  extern char *libintl_dgettext (const char *__domainname, const char *__msgid) _INTL_MAY_RETURN_STRING_ARG (2);
...
#    endif
  extern char *dcgettext (const char *__domainname, const char *__msgid,
			  int __category) _INTL_ASM (libintl_dcgettext) _INTL_MAY_RETURN_STRING_ARG (2);
#  endif
...
#  ifdef _INTL_REDIRECT_INLINE
  extern char *libintl_ngettext (const char *__msgid1, const char *__msgid2,
				 unsigned long int __n) _INTL_MAY_RETURN_STRING_ARG (1) _INTL_MAY_RETURN_STRING_ARG (2);
  static inline
...
#    endif
  extern char *ngettext (const char *__msgid1, const char *__msgid2,
    ...
    _INTL_ASM (libintl_ngettext) _INTL_MAY_RETURN_STRING_ARG (1) _INTL_MAY_RETURN_STRING_ARG (2);
#  endif
...
#    endif
  extern char *dngettext (const char *__domainname,
			  ...
			  unsigned long int __n)
    _INTL_ASM (libintl_dngettext) _INTL_MAY_RETURN_STRING_ARG (2) _INTL_MAY_RETURN_STRING_ARG (3);
#  endif
...
#    endif
  extern char *dcngettext (const char *__domainname,
			   const char *__msgid1, const char *__msgid2,
			   unsigned long int __n, int __category)
    _INTL_ASM (libintl_dcngettext) _INTL_MAY_RETURN_STRING_ARG (2) _INTL_MAY_RETURN_STRING_ARG (3);
#  endif
...
#      ifdef _INTL_REDIRECT_INLINE
  extern wchar_t *libintl_wbindtextdomain (const char *__domainname, const wchar_t *__wdirname);
...
#        endif
  extern wchar_t *wbindtextdomain (const char *__domainname, const wchar_t *__wdirname) _INTL_ASM (libintl_wbindtextdomain);
#      endif
#    endif
...
#      endif
  extern char *bind_textdomain_codeset (const char *__domainname,
					const char *__codeset) _INTL_ASM (libintl_bind_textdomain_codeset);
#    endif
...
#    if !((defined fprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_fprintf)
  /* don't override gnulib */
#      undef fprintf
...
#      endif
#    endif
#    if !((defined vfprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_vfprintf)
  /* don't override gnulib */
#      undef vfprintf
...
#      endif
#    endif
#    if !((defined printf && defined _GL_STDIO_H) || defined GNULIB_overrides_printf)
  /* don't override gnulib */
#      undef printf
...
#      endif
#    endif
#    if !((defined vprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_vprintf)
  /* don't override gnulib */
#      undef vprintf
...
#      endif
#    endif
#    if !((defined sprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_sprintf)
  /* don't override gnulib */
#      undef sprintf
#      define sprintf libintl_sprintf
...
#      endif
#    endif
#    if !((defined vsprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_vsprintf)
  /* don't override gnulib */
#      undef vsprintf
...
#    endif
#    if @HAVE_SNPRINTF@
#      if !((defined snprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_snprintf)
  /* don't override gnulib */
#        undef snprintf
...
#        endif
#      endif
#      if !((defined vsnprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_vsnprintf)
  /* don't override gnulib */
#        undef vsnprintf
...
#    endif
#    if @HAVE_ASPRINTF@
#      if !((defined asprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_asprintf)
  /* don't override gnulib */
#        undef asprintf
...
#        endif
#      endif
#      if !((defined vasprintf && defined _GL_STDIO_H) || defined GNULIB_overrides_vasprintf)
  /* don't override gnulib */
#        undef vasprintf
...
#    ifndef GNULIB_defined_newlocale
  /* don't override gnulib */
#      undef newlocale
...
#      endif
#    endif
#    ifndef GNULIB_defined_duplocale
  /* don't override gnulib */
#      undef duplocale
...
#      endif
#    endif
#    ifndef GNULIB_defined_freelocale
  /* don't override gnulib */
#      undef freelocale
...
#    ifndef GNULIB_defined_setlocale
  /* don't override gnulib */
#      undef setlocale
...
#    endif
#  endif
  /* Support for relocatable packages.  *//* Sets the original and the current installation prefix of the package.
