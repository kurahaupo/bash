...
#  define PST_ALLOWOPNBRC	0x000004
				 /* allow open brace for function def */
#  define PST_NEEDCLOSBRC	0x000008
				 /* need close brace -- unused */
...
#  define DOLBRACE_QUOTE	0x40
				/* single quote is special in double quotes */
#  define DOLBRACE_QUOTE2	0x80
				/* single quote is semi-special in double quotes */
